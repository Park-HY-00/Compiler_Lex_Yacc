...
{
      18,     0,    -1,    12,    19,    13,    -1,    19,    20,    -1,
      20,    -1,     1,    11,    -1,     9,     8,    21,    11,    -1,
      15,    21,    16,    -1,    21,     3,    21,    -1,    21,     4,
      21,    -1,    21,     5,    21,    -1,    21,     6,    21,    -1,
       7,    21,    -1,    22,    -1,     9,    -1,    10,    -1
};
...
{
  "$end", "error", "$undefined", "ADD", "SUB", "MUL", "DIV", "SQR",
  "ASSGN", "ID", "NUM", "STMTEND", "START", "END", "ID2", "'('", "')'",
  "$accept", "program", "stmt_list", "stmt", "expr", "term", YY_NULL
};
#endif
...
{
      -7,     3,     8,    -1,    16,    -2,    -8,    -8,    -8,    18,
      -8,    -8,    18,    -8,    -8,    18,    15,    -8,    -8,    -3,
      18,    18,    18,    18,    -8,    -8,    17,    17,    -8,    -8
};
...
{
      20,    21,    22,    23,     3,     1,    18,     4,     7,    19,
       8,    10,     4,    25,    26,    27,    28,    29,    20,    21,
      22,    23,    22,    23,     9,    12,    24,    13,    14,    11,
       0,     0,     0,    15
};
...
{
       3,     4,     5,     6,     1,    12,    12,     9,     0,    15,
      11,    13,     9,    16,    20,    21,    22,    23,     3,     4,
       5,     6,     5,     6,     8,     7,    11,     9,    10,     5,
      -1,    -1,    -1,    15
};
...
{
       0,    12,    18,     1,     9,    19,    20,     0,    11,     8,
      13,    20,     7,     9,    10,    15,    21,    22,    21,    21,
       3,     4,     5,     6,    11,    16,    21,    21,    21,    21
};
...
/* Line 1792 of yacc.c  */
#line 74 "cbu2.y"
    { (yyval)=MakeOPTree(MUL, (yyvsp[(2) - (2)]), (yyvsp[(2) - (2)])); }
    break;
